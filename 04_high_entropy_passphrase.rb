...
count1 = input.select{ |line| line !~ word_twice_re }.count
print("Problem 1 count: #{count1}\n")

input_with_sorted_letters = input.map { |line|
								line.split.map { |word| 
									word.chars.sort.join 
								}.join(' ')
							}

count2 = input_with_sorted_letters.select{ |line| line !~ word_twice_re }.count
print("Problem 2 count: #{count2}\n")
